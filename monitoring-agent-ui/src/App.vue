...
<template>
  <main>
    <section class="layout">
      <div class="header">
        <img src="/src/assets/logo.png" alt="logo" width=32 height=32 className="logo" />
        <span class="navbar-title">Monitoring agent UI</span>
        <span class="navbar-description">A simple monitoring agent</span>
      </div>
      <div class="sidebar">
        <div class="sidebarflex">
          <div class="siderbarchoice">
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link" href="/monitors" data-toggle="tooltip" data-placement="top" title="Show all monitors with current status.">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/dashboard" data-toggle="tooltip" data-placement="top" title="Show dashboard with load averages memory etc.">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <li class="nav-item">
                <a class="nav-link" href="/processes" data-toggle="tooltip" data-placement="top" title="List processes.">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/system" data-toggle="tooltip" data-placement="top" title="Show information  about the systems being monitored.">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <li class="nav-item">
                <a class="nav-link" href="/about" data-toggle="tooltip" data-placement="top" title="About this application.">
      ...
      <div class="footer">
        ...
        <div class="footer-text footerorder2">Github project: <a class="text-info"
            href="https://github.com/kjetilfjellheim/monitoring-agent">Link</a></div>
        <div class="footer-text footerorder3">License: <a class="text-info" href="https://www.apache.org/licenses/LICENSE-2.0.html">Apache
            2.0 license</a></div>
      </div>
    </section>
  </main>
