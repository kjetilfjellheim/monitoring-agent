...
<template>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-5 small no-margin" v-if="monitor.lastErrorTime != null">Last eror
                                        time
                                    </dt>
                                    <dd class="col-sm-7 small no-margin text-truncate"
                                        v-if="monitor.lastErrorTime != null">
                                        {{ monitor.lastErrorTime }}</dd>
                                    <dt class="col-sm-12 small no-margin" v-if="monitor.lastError != null">Last error
                                    </dt>
    ...
    <div v-if="!monitors" class="text-center">
