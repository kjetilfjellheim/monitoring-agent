...
fn main() {
     ...
     */
    let stdout = match OpenOptions::new().read(true).write(true).append(true).create(true).open("/var/log/monitoring_agent.out") {
        Ok(file) => file,
        Err(err) => {
    ...
    let stderr = match OpenOptions::new().read(true).write(true).append(true).create(true).open("/var/log/monitoring_agent.err") {
        Ok(file) => file,
        Err(err) => {
